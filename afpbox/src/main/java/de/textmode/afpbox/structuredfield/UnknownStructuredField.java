 ...
 */
public class UnknownStructuredField extends StructuredFieldBase {

    /**
     * Constructs the {@link UnknownStructuredField}.
     *
     * @param is the {@link AfpDataInputStream} the Structured Field data is read from.
     */
    public UnknownStructuredField(final AfpDataInputStream is) {
