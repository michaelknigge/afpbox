...
/**
 * The Relative Move Inline control sequence moves the inline coordinate relative to
 * the current inline coordinate position.
 */
public final class RelativeMoveInline extends PtocaControlSequence {

    /**
     * Constructs the {@link RelativeMoveInline}.
     *
     ...
     */
    RelativeMoveInline(final int functionType, final byte[] data) throws AfpException {
        super(functionType, data, "RMI", 4);
    }
